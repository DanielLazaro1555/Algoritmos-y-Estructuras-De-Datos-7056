 ...
 * Realiza la fusión y ordenamiento de listas de productos eliminando duplicados.
...
public class FusionProductos {
    ...
    /**
     * Combina y ordena dos listas de productos de forma alfabética, eliminando duplicados.
     * 
     * @param turnoManana Arreglo con los productos vendidos en el turno de la mañana.
     ...
     */
    public String[] combinarYOrdenar(String[] turnoManana, String[] turnoTarde) {
        // Usar TreeSet para combinar, eliminar duplicados y ordenar automáticamente
        Set<String> productosUnicos = new TreeSet<>();
        productosUnicos.addAll(Arrays.asList(turnoManana));
