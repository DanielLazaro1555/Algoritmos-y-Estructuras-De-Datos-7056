...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] productosUnicos = fusionador.combinarYOrdenar(turnoMañana, turnoTarde);
